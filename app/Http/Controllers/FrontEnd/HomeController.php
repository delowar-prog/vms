...
class HomeController extends Controller {
	...
	public function index() {
		...
		$company_services = CompanyServicesModel::get();
		$vehicle_type = VehicleTypeModel::get();
		$token=null;
		// dd($company_services = $data['company_services']);
		//return $company_services;
		return view('frontend.home',compact('testimonial','vehicle','company_services','vehicle_type','token'));
	}
	...
	public function booking_guide() {
		$data['team'] = TeamModel::get();
		return view('frontend.booking_guide', $data);
	}
	public function free_cancellation() {
		$data['team'] = TeamModel::get();
		return view('frontend.free_cancellation', $data);
	}
	public function payment_method() {
		$data['team'] = TeamModel::get();
		return view('frontend.payment_method', $data);
	}
	// start taxi and service
	public function taxi() {
		$data['team'] = TeamModel::get();
		return view('frontend.taxi', $data);
	}
	public function service() {
		$data['team'] = TeamModel::get();
		return view('frontend.service', $data);
	}
	// end taxi and service
