...
class DriversApi extends Controller {
...

	{
		 ...
		 $destinationPath='assets/assets/temporary_image/'.$request->fcm_id;
		...
		$destinationPath1='assets/assets/document_driver';
...

	{
...

		{
			...
			foreach ($arr as $key => $source_file) {
				...
				$destination_path = 'assets/assets/document_driver/';	

				$source='assets/assets/temporary_image/'.$request->fcm_id.'/'.$source_file;
...

	{
		...
		$folderPath = 'assets/assets/temporary_image/' . $request->fcm_id;
