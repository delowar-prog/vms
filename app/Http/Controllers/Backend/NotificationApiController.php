...
class NotificationApiController extends Controller {
	...
	public function vehicle_registration() {
		...
		foreach ($notifications as $row) {
			...
			$details[] = array(
				'image' => ($vehicle->vehicle_image != null) ? asset('uploads/' . $vehicle->vehicle_image) : asset("assets/assets/images/vehicle.jpeg"),
	...
	public function driver_license() {
		...
		foreach ($notifications as $row) {
			...
			$details[] = array(
				'image' => ($user->driver_image != null) ? asset('uploads/' . $user->driver_image) : asset("assets/assets/images/no-user.jpg"),
	...
	public function service_reminder() {
		...
		foreach ($notifications as $row) {
			...
			$details[] = array(
				'image' => ($reminder->vehicle->vehicle_image != null) ? asset('uploads/' . $reminder->vehicle->vehicle_image) : asset("assets/assets/images/vehicle.jpeg"),
