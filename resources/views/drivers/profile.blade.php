    ...
    <div class="card card-info card-outline">
      <div class="card-body box-profile">
        <div class="text-center">
          ...
          @else
            <img src="{{ asset("assets/assets/images/no-user.jpg")}}" alt="User profile picture" class="profile-user-img img-responsive img-circle">
          @endif
        </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <?php
                          $bookingType = $row->getMeta('return');
                       ...
                       ?>
                        ...
                        @if($bookingType == 1 && $parentBooking)
                          <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/return_way.svg') }}" alt="Return Way" height="30" width="30">
                        @else
                          <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/one_way.svg') }}" alt="One Way" height="30" width="30">
                        @endif
                      </td>
