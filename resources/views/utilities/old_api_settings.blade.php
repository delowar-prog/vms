            ...
            <div class="tab-pane" id="firebase">
              ...
              <div class="row">
                ...
                <div class="col-md-12" style="font-size:20px" >
                  ...
                  <h6 class="text-uppercase"><a href="{{asset('assets/assets/samples/firebase_credentials.json')}}" download>@lang('fleet.fsf')</a></h6>
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <ol class="text-muted">
                      ...
                      <li>@lang('fleet.ymcb') <strong><a href="{{ asset('assets/assets/images/billing-Account.png') }}">@lang('fleet.gmp')</a></strong> @lang('fleet.tuma').</li>
