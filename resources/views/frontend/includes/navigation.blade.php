         ...
         <div class="container-fluid">
             <div class="main-menubar">
                 <a class="navbar-brand" href="{{ route('frontend.home') }}"> <img
                          src="{{ asset('assets/assets/images/logo.webp') }}" width="172px"
                         height="auto"></a>

                 <div class="res-collapse d-flex d-sm-flex d-md-flex d-lg-none d-xl-none ">
                     @if (!Auth::guest() && (Auth::user()->user_type == 'C' || Auth::user()->user_type == 'D'))
                         <div class="login-btn-res d-none">
                             <a href="{{ url('/login') }}" style="text-decoration:none;border-radious:2px;"> <button
                                     type="button" class="btn " data-bs-toggle="modal">@lang('frontend.login')</button></a>
                         </div>
                     @else
                 ...
                 <div class="collapse navbar-collapse" id="navbarsExample09">
                     <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                         ...
                         {{-- <li class="nav-item">
                            <a class="nav-link" href="{{ route('frontend.booking_guide') }}">
                                @lang('Booking Guide')
                            </a>
                        </li> --}}
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('frontend.free_cancellation') }}">
                                @lang('Free Cancellation')
                            </a>
                        </li>
                         <li class="nav-item">
                                 ...
                                 <div class="modal-header">
                                     <div class="edit-profile d-xl-flex d-lg-flex d-md-flex d-sm-none d-none">
                                         <a href="{{ url('dashboard') }}" target="_blank"
                                             class="custom-btn">@lang('frontend.Dashboard')</a>
                                         <a href="#" data-bs-toggle="modal" data-bs-target="#edit_profile"
                                             class="custom-btn">
                                     ...
                                     <div class="container">
                                         <div class="row profile-sec">
                                             <div class="col-lg-6 col-md-6 col-12  set-profile">
                                                 ...
                                                 <div
                                                     class="edit-profile d-xl-none d-lg-none d-md-none d-sm-flex d-flex justify-content-center pt-4">
                                                     <a href="{{ url('dashboard') }}" target="_blank"
                                                         class="custom-btn">@lang('frontend.Dashboard')</a>
                                                     <a href="#" data-bs-toggle="modal"
                                                         data-bs-target="#edit_profile"
                                                         class="custom-btn">@lang('frontend.Edit_Profile')</a>
                                                 </div>
                                             </div>
                                                                         ...
                                                                         <div class="edit-profile-form">
                                                                             <div class="container">
                                                                                 <div class="row">
                                                                                     ...
                                                                                     <div class="col-12">
                                                                                         <div
                                                                                             class="col-md-12  gender-btn-edit-profile">
                                                                                             <div class="row ">
                                                                                                 <div class="col-4">
                                                                                                     <label
                                                                                                         class="form-label gender-label">Gender</label>
                                                                                                 </div>
                                                                                                 <div
                                                                                                     class="col-8 p-0">
                                                                                                     <input
                                                                                                     ...
                                                                                                     <ul
                                                                                                         ...
                                                                                                         <li>
                                                                                                             ...
                                                                                                             <label
                                                                                                                 for="a25">@lang('frontend.male')</label>
                                                                                                         </li>
                                                                                                         <li>
                                                                                                             <input
                                                                                                                 type="radio"
                                                                                                             ...
                                                                                                             <label
                                                                                                                 for="a50">@lang('frontend.female')</label>
                                                                                                         </li>
                                                                                                     </ul>
                                                         ...
                                                         <div class="profile-round-img">
                                                             <div class="p-r-img ">
                                                                 ...
                                                                 <div class="p-r-img-overlay">
                                                                     <a href="#"
                                                                         class="upload-button">@lang('frontend.Change_Photo')</a>
             ...
             @else
                 ...
                 <div class="signin-signup-btn d-md-none d-lg-flex">
                     ...
                     <a href="{{ url('/login') }}" style="text-decoration:none;border-radious:2px;"><button
                             type="button"
                             class="btn login d-none d-sm-none d-md-none d-lg-flex">@lang('frontend.login')</button></a>

                     {{-- <a href="{{ url('/sign_up') }}" style="text-decoration:none;border-radious:2px;"><button
                             type="button" class="btn sign-up d-md-none d-lg-flex">@lang('frontend.sign_up')</button>
                    </a> --}}
                     <!-- Sign Up Hover Menu -->
