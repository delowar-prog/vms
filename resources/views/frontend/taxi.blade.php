...
@section('css')
<link rel="stylesheet" href="{{ asset('assets/assets/frontend/about.css') }}">
@endsection
@section('content')
@if(request()->is('about'))
  <style>
   ...
   <div class="row me-0">
      ...
      <div class="col-12 col-sm-12 col-md-12 col-lg-6">
         ...
         <div class="about-hero-section-round">
            ...
            <img src="{{ asset('assets/assets/images/round2.png') }}" class="img-fluid" alt="round">
      ...
      <div class="col-12 col-sm-12 col-md-12 col-lg-12">
         ...
         <div class="about-hero-section-round-fleet">
            ...
            <img src="{{ asset('assets/assets/images/FLEET1.png') }}" class="img-fluid" alt="fleet">
         ...
         <div class="row d-flex">
            ...
            <div class="col-md-6 col-lg-6 order-md-last">
               ...
               <div class="about-hero-img">
                  ...
                  <img src="{{ asset('assets/assets/images/about-hero-img.png') }}" alt="about-hero-img">
      ...
      <div class="row me-0 ms-0">
         ...
         <div class="col-12 col-md-5 col-lg-4 mt-5">
            ...
            <div class="about-fleet-manager-image">
               ...
               <img src="{{ asset('assets/assets/images/Mask.png') }}" class="image-fluid" alt="mask"
         ...
         <div class="col-md-5">
            ...
            <div class="city-servey">
               ...
               <div class="city-servey-img">
                  ...
                  <img src="{{ asset('assets/assets/images/Mask_Group_7.png') }}" alt="mask">
         ...
         <div class="col-md-5 mt-4 mt-sm-4 mt-md-0 mt-lg-0 mt-xl-0">
            ...
            <div class="vehicle-servey">
               ...
               <div class="vehicle-servey-img">
                  ...
                  <img src="{{ asset('assets/assets/images/Mask_Group_9.png') }}" alt="">
            ...
            <div class="col-md-5">
               ...
               <div class="client-1">
                  ...
                  <div class="client-1-img">
                     ...
                     <img src="{{ url('assets/assets/images/client1.png') }}" alt="no-user">
               ...
               <div class="col-md-5">
                  ...
                  <div class="client-2">
                     ...
                     <div class="client-2-img">
                        ...
                        <img src="{{ url('assets/assets/images/client2.png') }}" alt="no-user">
                  ...
                  <div class="col-12">
                     ...
                     <div class="client-1-responsive-img">
                        ...
                        <div class="client-1-responsive-img1">
                           ...
                           <img src="{{ asset('assets/assets/images/client1.png') }}" alt="">
                  ...
                  <div class="col-12">
                     ...
                     <div class="client-2-responsive-img">
                        ...
                        <div class="client-2-responsive-img1">
                           ...
                           <img src="{{ asset('assets/assets/images/client2.png') }}" alt="">
