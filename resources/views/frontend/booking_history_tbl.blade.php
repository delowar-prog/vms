            ...
            <div class="set-icon-image">
                @if($booking && $booking->return_flag == 1)
                        ...
                        @if(isset($p))
                            ...
                            <img src="{{ url('/assets/assets/customer_dashboard/assets/assets/img/return_way.svg') }}" width="30" height="30" class="return-way" title="Return Way">

                        @else
                            <img src="{{ url('/assets/assets/customer_dashboard/assets/assets/img/one_way.svg') }}" width="30" height="30" class="one-way" title="One Way">
