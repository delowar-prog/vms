...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('assets/assets/customer_dashboard/assets/assets/main_css/receipt.css') }}">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="invoice-logo">
                        <img src="{{ asset('assets/assets/images/' . Hyvikk::get('logo_img')) }}" class="img-fluid" alt="Logo">
                    </div>
                </div>
                <div class="col-6">
                    <div class="receipt">
                    ...
                    <div class="col-12">
                        <div class="invoice-help text-center">
                            ...
                            <div class="authorised-sign mt-4">
                                ...
                                <img src="{{ asset('assets/assets/images/signature.jpg') }}" alt="signature"
