            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-7 col-md-7 col-lg-7 col-xl-7 hover-eff my-auto text-start text-sm-end text-md-end text-lg-end text-xl-end">
                    ...
                    <button class="btn btn-icon btn-3 breakdown_btn" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal102">
                        ...
                        <span class="btn-inner--icon"><img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/breakdown.svg') }}"></span>
                    ...
                    <a href="mailto:help@hyvikk.com" class="btn btn-icon btn-3 contact_btn" type="button">
                        ...
                        <span class="btn-inner--icon"><img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/contact.svg') }}"></span>
                    ...
                    <button class="btn btn-icon btn-3 driver_alert_btn" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal103">
                        ...
                        <span class="btn-inner--icon"><img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/driver_alert.svg') }}"></span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <div class="location">
                                    ...
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/location.svg') }}">
                            ...
                            <div class="col-4">
                                ...
                                <div class="speed">
                                    ...
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/speed.svg') }}">
                                ...
                                <div class="col-12 col-sm-6 col-md-6 col-xl-6 col-lg-6">
                                    ...
                                    <div class="vehicle-img-name">
                                        ...
                                        <div class="vehicle-img">
                                            ...
                                            <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/vehicle.svg') }}" >
                                    ...
                                    <div class="driver_call col-12 col-sm-6 col-md-6 col-xl-6 col-lg-6">
                                        ...
                                        <a href="tel:{{($driver->phone??'-')}}">
                                                ...
                                                <button class="btn btn-icon btn-3 call_btn" type="button" style="text-transform: unset;">
                                                    ...
                                                    <span class="btn-inner--icon"><img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/phone.svg') }}"></span>
                                         ...
                                         <a href="https://wa.me/{{($driver->phone??'-')}}">
                                            ...
                                            <button class="btn btn-icon btn-3 whatsapp_btn" type="button" style="text-transform: unset;">
                                                ...
                                                <span class="btn-inner--icon"><img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/icon _WhatsApp_.svg') }}"></span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-3  d-none d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-center">
                                    ...
                                    <div class="fare_detail_img">
                                        ...
                                        <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/fare_detail.svg') }}">
