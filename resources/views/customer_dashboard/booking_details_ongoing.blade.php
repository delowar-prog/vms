...
<link rel="stylesheet" href="{{ asset('assets/assets/customer_dashboard/assets/assets/main_css/booking_ongoing.css') }}">
                            ...
                            <div class="col-sm-12 col-md-5 col-lg-5 col-xl-5">
                                ...
                                <div class="map d-flex " style="align-items:center">
                                    ...
                                    <div class="distance_map_img">
                                        ...
                                        <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/map_location.svg') }}">
                            ...
                            <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mt-3 mt-sm-3 mt-md-0 mt-lg-0 mt-xl-0">
                                ...
                                <div class="map d-flex" style="align-items:center">
                                    ...
                                    <div class="distance_map_img">
                                        ...
                                        <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/map_speed.svg') }}">
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-3 mt-sm-3 mt-md-0 mt-lg-0 mt-xl-0">
                                ...
                                <div class="map d-flex" style="align-items:center">
                                    ...
                                    <div class="distance_map_img">
                                        ...
                                        <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/map_distance.svg') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 fare d-none d-sm-none d-md-flex d-lg-flex d-xl-flex  ">
                            ...
                            <div class="booking_fare_img">
                                ...
                                <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/fare_booking.svg') }}">
                            ...
                            border-radius: 5px;
                             ...
                             ">
                                            ...
                                            @else
                                                ...
                                                <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/assign_vehicle.svg') }}"
                                            ...
                                            <a href="tel:{{ $driver->phone ?? '-' }}">
                                                ...
                                                <button class="btn btn-icon btn-3 call_btn me-4" type="button"
                                                    ...
                                                    <span class="btn-inner--icon"><img
                                                            ...
                                                            src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/phone.svg') }}"></span>
                        ...
                        <div
                            ...
                            <a href="mailto:help@hyvikk.com"
                                ...
                                <span class="btn-inner--icon"><img
                                        ...
                                        src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/ongoing_contact.svg') }}"></span>
                                ...
                                <div class="btn-group">
                                    ...
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal100"
                                        ...
                                        <span class="btn-inner--icon"><img
                                                ...
                                                src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/ongoing_breakdown.svg') }}"></span>
                                ...
                                <div class="btn-group">
                                    ...
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal101"
                                        ...
                                        <span class="btn-inner--icon"><img
                                                ...
                                                src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/ongoing_driver_alert.svg') }}"></span>
