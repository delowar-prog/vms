...
@endsection
@section('css')
<link rel="stylesheet" href="{{ asset('assets/assets/customer_dashboard/assets/assets/main_css/booking.css') }}">
@endsection
@section('contents')
@section('breadcrumb')
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <button class="btn btn-icon btn-3 filter_btn mb-0 dropdown-toggle myClass filterBtn"
                                            ...
                                            <span class="btn-inner--icon">
                                                <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/icon _Horizontal Sliders_.svg') }}">
                                            </span>
...
$(document).on("click", '[data-action="classfound1"]', function (e) {
    ...
    $('[data-action="classfound1"]').find(".drop-img").attr("src", "{{url('/assets/assets/customer_dashboard/assets/assets/img/svg/dropdown_dots.svg')}}");
    $('[data-action="classfound1"]').find(".return-way").attr("src", "{{url('/assets/assets/customer_dashboard/assets/assets/img/return_way.svg')}}");
    $('[data-action="classfound1"]').find(".one-way").attr("src", "{{url('/assets/assets/customer_dashboard/assets/assets/img/one_way.svg')}}");
    ...
    $(this).find(".drop-img").attr("src", "{{url('/assets/assets/customer_dashboard/assets/assets/img/svg/dropdown_dots_light.svg')}}");
    $(this).find(".return-way").attr("src","{{url('/assets/assets/customer_dashboard/assets/assets/img/return_way.svg')}}");
    $(this).find(".one-way").attr("src","{{url('/assets/assets/customer_dashboard/assets/assets/img/one_way.svg')}}");
});
$.ajax({
