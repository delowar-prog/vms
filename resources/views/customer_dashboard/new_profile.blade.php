...
<link rel="stylesheet" href="{{ asset('assets/assets/customer_dashboard/assets/assets/main_css/new_profile.css') }}">
                    ...
                    <div class="user_details mb-3 set-pofile-div">
                        ...
                        <div class="user_info sign_title">
                            ...
                            @if(isset(Auth::user()->gender) && Auth::user()->gender == 1)
                                   ...
                                   <p class="mb-0 g_male">Male <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/g_male.svg') }}" class="ms-2"> </p>

                           @elseif(isset(Auth::user()->gender) && Auth::user()->gender == 0)

                                  <p class="mb-0 g_female">Female <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/g_female.svg') }}" class="ms-2"> </p> 
