...
<link rel="stylesheet" href="{{ asset('assets/assets/customer_dashboard/assets/assets/main_css/dashboard.css') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 text-end">
                                ...
                                <div class="icon icon-shape bg-gradient-info shadow text-center border-radius-md">
                                    ...
                                    {{-- <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/icon-1.svg') }}"> --}}
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/img/svg/icon-1.svg') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 text-end">
                                ...
                                <div class="icon icon-shape bg-gradient-info shadow text-center border-radius-md">
                                    ...
                                    {{-- <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/icon-2.svg') }}"> --}}
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/img/svg/icon-2.svg') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 text-end">
                                ...
                                <div class="icon icon-shape bg-gradient-info shadow text-center border-radius-md">
                                    ...
                                    {{-- <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/icon-3.svg') }}"> --}}
                                     <img src="{{ asset('assets/assets/customer_dashboard/assets/img/svg/icon-3.svg') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 text-end">
                                ...
                                <div class="icon icon-shape bg-gradient-info shadow text-center border-radius-md">
                                    ...
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/img/svg/icon-4.svg') }}">
                        ...
                        <div class="col-6">
                            ...
                            <div class="place-distance-speed-img">
                                ...
                                <div class="minimal-feature">
                                    ...
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/img/svg/places.svg') }}">
                        ...
                        <div class="col-6">
                            ...
                            <div class="place-distance-speed-img">
                                ...
                                <div class="minimal-feature">
                                    ...
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/img/svg/distance.svg') }}">
                        ...
                        <div class="col-6">
                            ...
                            <div class="place-distance-speed-img">
                                ...
                                <div class="minimal-feature">
                                    ...
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/img/svg/minutes.svg') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-12 d-flex">
                        ...
                        <div class="form-group " style="width:100%">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text" id="basic-addon1">
                                    ...
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/img/svg/icon _Search_.svg') }}">
                        ...
                        <button class="btn btn-icon btn-2 custom-btn-dark ongoing-click" style="" type="button">
                            ...
                            <span class="btn-inner--icon"><img src="{{ asset('assets/assets/customer_dashboard/assets/img/svg/icon _Horizontal Sliders_.svg') }}"></span>
...
function initMap() {
    ...
    $(document).ready(function() {
        ...
        var startIcon = "{{ asset('assets/assets/images/pickup.png') }}";

        var endIcon = "{{ asset('assets/assets/images/dropup.png') }}";

        var currentIcon = "{{ asset('assets/assets/images/current.png') }}";
            ...
            if (data.latitude && data.longitude) {
                ...
                if (marker) {
                    ...
                    marker = new google.maps.Marker({
                        ...
                        icon: "{{ asset('assets/assets/images/current.png') }}" 
...
$('[data-action="classfound"]').find('img').attr("src", "{{url('/assets/assets/customer_dashboard/assets/assets/img/svg/dropdown_dots.svg')}}");
...
$(this).find(".img-set").find('img').attr("src", "{{url('/assets/assets/customer_dashboard/assets/assets/img/svg/dropdown_dots_light.svg')}}");
...

        {
          ...
          var $element = $('body [data-action="classfound"]:first');
            ...
            if ($element.length > 0) {
                ...
                $element.find('img').attr("src", "{{url('/assets/assets/customer_dashboard/assets/assets/img/svg/dropdown_dots.svg')}}");
