...
<link rel="stylesheet" href="{{ asset('assets/assets/customer_dashboard/assets/assets/main_css/booking_details.css') }}">
                      ...
                      <div class="col-12 ">
                        ...
                        <div class="booking_assign_vehicle">
                          ...
                          <div class="assign_vehicle_img">
                            ...
                            <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/assign_vehicle.svg') }}" style="border-radius: 5px;">
            ...
            <div class="col-6">
              ...
              <div class="booking_btn_group justify-content-end">            
                ...
                <a class="btn btn-icon btn-3 receipt_btn d-flex align-items-center" href="{{url('bookings/receipt/'.$data->id)}}">          
                  ...
                  <span class="btn-inner--icon"><img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/receipt.svg') }}"></span>
            ...
            <div class="col-6">
              ...
              <div class="booking_btn_group justify-content-start d-flex align-items-center">    
                ...
                <a class="btn btn-icon btn-3 invoice_btn" href="{{url('bookings/invoice/'.$data->id)}}">          
                  ...
                  <span class="btn-inner--icon"><img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/receipt-text-check-outline.svg') }}"></span>
            ...
            geocoder.geocode({'address': endAddress}, function(resultsEnd, status) {
                ...
                if (status === 'OK') {
                    ...
                    var startMarker = new google.maps.Marker({
                        ...
                        icon:"{{ asset('assets/assets/images/pickup.png') }}" 
                    ...
                    var endMarker = new google.maps.Marker({
                        ...
                        icon: "{{ asset('assets/assets/images/dropup.png') }}" 
