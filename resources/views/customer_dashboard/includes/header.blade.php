        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5 d-flex">
                <li class="breadcrumb-item text-sm">
                    <a href="{{ url('/dashboard') }}" class="opacity-5 text-dark">Pages</a>
                </li>
...
<nav class="login_info navbar navbar-expand-lg top-0 z-index-3 position-absolute my-0 py-2 start-0 end-0 w-100">
    <a class="navbar-brand font-weight-bolder ms-3 ms-lg-3" href="{{ url('/') }}">
        <img src="{{ asset('assets/assets/images/' . Hyvikk::get('logo_img')) }}" width="172" height="auto" alt="Logo">
    </a>
    ...
    <div class="collapse navbar-collapse w-100" id="navigation2">
        <div class="container-fluid px-3 px-lg-4">
            <div class="row g-0 align-items-center w-100">
                ...
                <div class="col-12 col-lg-6">
                    <ul class="navbar-nav d-flex flex-row flex-sm-row flex-md-row justify-content-center justify-content-sm-around justify-content-md-around justify-content-lg-end justify-content-xl-end align-items-start align-items-sm-start align-items-md-start align-items-lg-center align-items-xl-center mt-3 mt-sm-3 mt-md-3 mt-lg-0 mt-xl-0">
                        <li class="nav-item d-flex align-items-center">
                            <a class="btn btn-round btn-sm mb-0 login_btn me-2" href="{{ route('log_in') }}">
                                @lang('frontend.login')
                            </a>
                        </li>

                        <li class="nav-item d-flex align-items-center ms-0 ms-sm-0 ms-md-0 ms-lg-4 ms-xl-4">
                            <a href="{{ route('sign_up') }}" class="btn btn-sm btn-round mb-0 me-1 sign_up_btn mt-0 mt-sm-0 mt-md-0 mt-lg-0 mt-xl-0">
            ...
            <div class="social-media">
                ...
                <div class="social_icon">
                    <a href="{{ Hyvikk::frontend('twitter') }}" class="social_icon_link d-none d-sm-none d-md-none d-lg-flex d-xl-flex">
                        <svg version="1.1" id="svg1" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="social_icon">
                    ...
                    <a href="{{ Hyvikk::frontend('facebook') }}" class="me-4 me-sm-4 me-md-4 me-lg-0 me-xl-0">
                        <i class="fab fa-facebook d-flex d-sm-flex d-md-flex d-lg-none d-xl-none" style="color:#316FF6; font-size:24px"></i>
                    </a>
                </div>
                ...
                <div class="social_icon">
                    ...
                    <a href="{{ Hyvikk::frontend('linkedin') }}" class="me-4 me-sm-4 me-md-4 me-lg-0 me-xl-0">
                        <i class="fab fa-linkedin d-flex d-sm-flex d-md-flex d-lg-none d-xl-none" style="color:#0A66C2;font-size:24px"></i>
                    </a>
                </div>
                ...
                <div class="social_icon">
                    ...
                    <a href="{{ Hyvikk::frontend('instagram') }}">
                        <i class="fab fa-instagram d-flex d-sm-flex d-md-flex d-lg-none d-xl-none" style="font-size:24px"></i>
                    </a>
                </div>
