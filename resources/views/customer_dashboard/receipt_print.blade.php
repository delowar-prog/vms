...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/assets/css/invoice_receipt_style.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/assets/customer_dashboard/assets/assets/main_css/receipt_print.css') }}">
            ...
            <div class="row">
                <div class="col-6 set-top-margin">
                    <div class="invoice-logo">
                        <img src="{{ asset('assets/assets/images/' . Hyvikk::get('logo_img')) }}" class="img-fluid"
                            alt="Logo">
                    </div>
                </div>
                <div class="col-6">
                        ...
                        <div class="invoice-help text-center">
                            ...
                            <div class="company-logo">
                                <a href="#" target="_blank">
                                    <img src="{{ asset('assets/assets/images/' . Hyvikk::get('logo_img')) }}" alt="Logo"
                            ...
                            <div class="authorised-sign mt-4">
                                ...
                                <img src="{{ asset('assets/assets/images/signature.jpg') }}" alt="signature" style="max-width: 100px;"> 
                            </div>
                        </div>
                    </div>
                </div>
