...
<head>
  ...
  {{-- <link rel="icon" href="{{ asset('assets/assets/images/'. Hyvikk::get('icon_img') ) }}" type="icon_img"> --}}
  <link rel="icon" href="{{ asset('assets/assets/images/logo.webp') }}">

  <!-- Font Awesome -->

  <link rel="stylesheet" href="{{ asset('assets/assets/css/plugins-fa-all.min.css') }}">

  <!-- Ionicons -->

  {{-- <link rel="stylesheet" href="{{asset('assets/assets/css/ionicons.min.css')}}"> --}}

  <!-- fullCalendar 2.2.5-->

  <link rel="stylesheet" href="{{asset('assets/assets/css/plugins-fullcalendar.min.css')}}">

  <link rel="stylesheet" href="{{asset('assets/assets/css/plugins-fullcalendar.print.css')}}" media="print">

  <!-- DataTables -->

  <link rel="stylesheet" href="{{asset('assets/assets/css/plugins-dataTables.bootstrap4.min.css')}}">

  <link rel="stylesheet" type="text/css" href="{{ asset('assets/assets/css/cdn-buttons.dataTables.min.css')}}">

  <!-- Select2 -->

  {{-- <link rel="stylesheet" href="{{asset('assets/assets/plugins/select2/select2.min.css')}}"> --}}
  ...
  <link rel="stylesheet" href="{{asset('assets/assets/css/dist-adminlte.min.css')}}">

  <!-- iCheck -->

  {{-- <link rel="stylesheet" href="{{asset('assets/assets/css/plugins-icheck-flat-blue.css')}}"> --}}

  <!-- iCheck for checkboxes and radio inputs -->

  {{-- <link rel="stylesheet" href="{{asset('assets/assets/css/plugins-icheck-all.css')}}"> --}}

  <!-- Morris chart -->

  {{-- <link rel="stylesheet" href="{{asset('assets/assets/plugins/morris/morris.css')}}"> --}}

  <!-- jvectormap -->

  {{-- <link rel="stylesheet" href="{{asset('assets/assets/plugins/jvectormap/jquery-jvectormap-1.2.2.css')}}"> --}}

  <!-- bootstrap wysihtml5 - text editor -->

  {{-- <link rel="stylesheet" href="{{asset('assets/assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')}}"> --}}

  <!-- Google Font: Source Sans Pro -->

  <link href="{{ asset('assets/assets/css/font-fonts.css') }}" rel="stylesheet">



  <link href="{{ asset('assets/assets/css/pnotify.custom.min.css')}}" media="all" rel="stylesheet" type="text/css" />
...
'subscription_url' => asset('assets/assets/push_notification/push_subscription.php'),
...
'serviceWorkerUrl' => asset("serviceWorker.js")
  ...
  <script src="{{asset('assets/assets/push_notification/app.js')}}"></script>
...
<body class="hold-transition {{auth()->user()->theme}} layout-fixed sidebar-mini" @if($language=="Arabic-ar" ) dir="rtl"
  ...
  <div class="wrapper">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                ...
                <img src="{{ asset("assets/assets/images/no-user.jpg")}}" class="img-size-50 mr-3 img-circle"
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{ url('admin/')}}" class="brand-link">
        ...
        <img src="{{ asset('assets/assets/images/logo.webp') }}" alt="Fleet Logo" class="brand-image"
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="image">
            ...
            <img src="{{ asset("assets/assets/images/no-user.jpg")}}" class="img-circle elevation-2" alt="User Image">
    ...
    <div class="content-wrapper">
      ...
      <audio id="chat-alert-sound" style="display: none">
        ...
        <source src="{{ asset('assets/assets/chat-sound.mp3') }}" />
  ...
  <script src="{{ asset('assets/assets/js/cdn-canvasjs.min.js')}}"></script>

  @yield('script2')

  <script src="{{asset('assets/assets/js/plugins-jquery.min.js')}}"></script>
  ...
  <script src="{{ asset('assets/assets/js/datetimepicker.js') }}"></script>

  <script src="{{asset('assets/assets/js/bootstrap-datepicker.min.js')}}"></script>

  {{-- <!-- fullCalendar 2.2.5 --> --}}

  <script src="{{asset('assets/assets/js/new_moment.min.js')}}"></script>
  ...
  {{-- <script src="{{asset('assets/assets/js/plugins-icheck.min.js')}}"></script> --}}

  <script src="{{asset('assets/assets/js/plugins-bootstrap.bundle.min.js')}}"></script>

  <script src="{{asset('assets/assets/js/plugins-select2.full.min.js')}}"></script>

  <script src="{{asset('assets/assets/js/plugins-fastclick.js')}}"></script>

  <script src="{{asset('assets/assets/js/cdn-jquery.dataTables.min.js')}}"></script>

  <script src="{{asset('assets/assets/js/plugins-dataTables.bootstrap4.min.js')}}"></script>

  <script src="{{ asset('assets/assets/js/cdn-dataTables.buttons.min.js')}}"></script>

  <script src="{{ asset('assets/assets/js/cdn-buttons.print.min.js')}}"></script>

  <script src="{{asset('assets/assets/js/adminlte.js')}}"></script>

  <script src="{{asset('web-sw.js?v3') }}"></script>



  <script type="text/javascript" src="{{ asset('assets/assets/js/cdn-jszip.min.js')}}"></script>

  <script type="text/javascript" src="{{ asset('assets/assets/js/cdn-pdfmake.min.js')}}"></script>

  <script type="text/javascript" src="{{ asset('assets/assets/js/cdn-vfs_fonts.js')}}"></script>

  <script type="text/javascript" src="{{ asset('assets/assets/js/cdn-buttons.html5.min.js')}}"></script>



  <script src="{{ asset('assets/assets/js/cdn-Chart.bundle.min.js')}}"></script>

  <script src="{{ asset('assets/assets/js/cdn-ckeditor.js')}}"></script>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      "language": {
            ...
            "url": '{{ asset("assets/assets/datatables/")."/".__("fleet.datatable_lang") }}',
  ...
  <script src="{{ asset('assets/assets/js/pnotify.custom.min.js')}}"></script>
