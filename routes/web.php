...
Route::group(['middleware' => ['IsInstalled', 'lang_check_user', 'front_enable']], function () {
    ...
    Route::get('taxi', 'FrontEnd\HomeController@taxi')->name('frontend.taxi');
    Route::get('booking', 'FrontEnd\HomeController@booking_guide')->name('frontend.booking_guide');
    Route::get('free-cancellation', 'FrontEnd\HomeController@free_cancellation')->name('frontend.free_cancellation');
    Route::get('payment-method', 'FrontEnd\HomeController@payment_method')->name('frontend.payment_method');
