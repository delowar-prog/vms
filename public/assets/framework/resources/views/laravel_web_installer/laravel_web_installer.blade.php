...
@section('style')
    <link href="{{ asset('assets/assets/css/installer-foriden-helper.css') }}" rel="stylesheet"/>
    <style>
        .form-control{
            height: 14px;
            width: 100%;
...
@endsection
@section('scripts')
    <script src="{{ asset('assets/assets/js/installer-jQuery-2.2.0.min.js') }}"></script>
    <script src="{{ asset('assets/assets/js/installer-foriden-helper.js')}}"></script>
    <script>
        $.ajaxSetup({
            headers: {
