    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <div class="main-menubar">
                <a class="navbar-brand" href="{{ route('frontend.home') }}"> <img src="{{ asset('assets/assets/images/'. Hyvikk::get('logo_img') ) }}" width="172px" height="auto"></a> 
                ...
                <div class="dropdown text-end refres" style="z-index: 999;">
                    <a href="#" class="d-block link-dark-none text-decoration-none" data-bs-toggle="modal"
                        ...
                        <div class="img-back-shadow1 img-back-shadow2">
                            <img src="{{ isset(Auth::user()->profile_pic) ? asset('uploads/'.Auth::user()->profile_pic) : asset('assets/assets/images/l6.png') }}"
                                                        ...
                                                        <div class="profile-round-img">
                                                            <div class="p-r-img ">
                                                                <img class="user-profile refresh-image"
                                                                    src="{{ isset(Auth::user()->profile_pic) ? asset('uploads/'.Auth::user()->profile_pic) : asset('assets/assets/images/l6.png') }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12 ps-0 pe-0  order-sm-first order-lg-last">
                                                ...
                                                <div class="reset-pass-img" style="">
                                                    ...
                                                    <div class="profile-bottom-round-img">
                                                        <div class="round-profile">
                                                            <img src="{{ asset('assets/assets/images/profile-round.png') }}"
                                                                alt="">
                                                        </div>
                                                    </div>
                                                </div>
