...
<section class="hero-section background-container">
    <div class="hero-section-round">
        <img src="{{ asset('assets/assets/images/round.png') }}" class="hero-section-round-1">
        <img src="{{ asset('assets/assets/images/Rectangle.png') }}" class="hero-section-shadow">
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 order-md-last order-sm-first">
                            <div class="main-slider-img">
                                <img src="{{ asset('assets/assets/images/slide1.png') }}">
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="book-a-cab-detail" id="book_Sec">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 ">
                <div class="feet-img">
                    <img src="{{ asset('assets/assets/images/FLEET.png') }}">
                </div>
            </div>
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-none d-sm-none d-md-none d-lg-block d-xl-block">
            ...
            <div class="car-img">
                <img src="{{ asset('assets/assets/images/round.png') }}" class="round-shape">
                    ...
                    <div class="owl-carousel">
                        ...
                        <div class="slides">
                            <img src="{{asset('uploads/'.$v->vehicle_image)}} " style="width:100%;"
                                data-icon="{{($v && $v->getMeta('icon')) ? asset('uploads/'.$v->icon)  :asset('assets/assets/images/car_blue.png')}}" data-make="{{$v->make_name}}" data-model="{{$v->model_name}}"
                            ...
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6 col-xxl-6 px-2 px-sm-4 px-md-2 px-lg-2 px-xl-4 image-hover">
                                <div class="car-features-detail">
                                    <div class="tesla-dark-logo">
                                        <img src="{{asset('assets/assets/images/car_blue.png')}}" class="show-icon-img" width="83px" height="107px">
