...
.page-header {
  ...
  <!-- Google Font -->
  <link rel="stylesheet" href="{{ asset('assets/assets/css/cdn/fonts.css')}}">
</head>
<body>
  <div class="wrapper">
      ...
      <div class="row" style="margin-bottom: 10px;">
        <div class="col-md-12">
          <h2 class="page-header">
            <span class="logo-lg">
              <img src="{{ asset('assets/assets/images/'. Hyvikk::get('logo_img') ) }}" class="navbar-brand logo_img" style="margin-top: -15px">
