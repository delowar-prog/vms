...
<head>
    ...
    <link id="pagestyle" href="{{ asset('assets/assets/customer_dashboard/assets/assets/css/soft-ui-dashboard.css?v=345435') }} "
        rel="stylesheet" />


    <link href="{{ asset('assets/assets/customer_dashboard/assets/assets/css/style.css') }}?v=1.1234568" rel="stylesheet" />
    @if (!Auth::guest() && Auth::user()->user_type == 'C')
    @else
        <link rel="stylesheet" href="{{ asset('assets/assets/customer_dashboard/assets/assets/main_css/app.css') }}">

    @endif

    <link rel="stylesheet" href="{{ asset('assets/assets/customer_dashboard/assets/assets/main_css/app1.css') }}">
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <script src="{{ asset('assets/assets/customer_dashboard/assets/assets/js/core/popper.min.js') }}"></script>
    <script src="{{ asset('assets/assets/customer_dashboard/assets/assets/js/core/bootstrap.min.js') }}"></script>
    <script src="{{ asset('assets/assets/customer_dashboard/assets/assets/js/plugins/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('assets/assets/customer_dashboard/assets/assets/js/plugins/smooth-scrollbar.min.js') }}"></script>
    <script src="{{ asset('assets/assets/customer_dashboard/assets/assets/js/plugins/chartjs.min.js') }}"></script>
