                        ...
                        <div class="row">
                            ...
                            <div class="col-4 text-end">
                                ...
                                <div class="icon icon-shape bg-gradient-info shadow text-center border-radius-md">
                                    ...
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/icon-4.svg') }}">
                        ...
                        <div class="col-6">
                            ...
                            <div class="place-distance-speed-img">
                                ...
                                <div class="minimal-feature">
                                    ...
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/places.svg') }}">
                        ...
                        <div class="col-6">
                            ...
                            <div class="place-distance-speed-img">
                                ...
                                <div class="minimal-feature">
                                    ...
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/distance.svg') }}">
                        ...
                        <div class="col-6">
                            ...
                            <div class="place-distance-speed-img">
                                ...
                                <div class="minimal-feature">
                                    ...
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/minutes.svg') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-12 d-flex">
                        ...
                        <div class="form-group " style="width:100%">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text" id="basic-addon1">
                                    ...
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/icon _Search_.svg') }}">
                        ...
                        <button class="btn btn-icon btn-2 custom-btn-dark ongoing-click" style="" type="button">
                            ...
                            <span class="btn-inner--icon"><img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/icon _Horizontal Sliders_.svg') }}"></span>
