...
@endsection
@section('css')
<link rel="stylesheet" href="{{ asset('assets/assets/customer_dashboard/assets/assets/main_css/create_booking.css') }}">
                                            ...
                                            <div class="input-group" style="border: 1px solid #d2d6da;">
                                                ...
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <img
                                                            src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/time.svg') }}">
                                                    </span>
                                                </div>
                                            </div>
                             ...
                             <div id="companyServicesCarousel" class="carousel slide" data-bs-ride="carousel">
                                 ...
                                 <div class="carousel-inner">
                                     ...
                                     <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                                         <img src="{{ $service->image ? url('uploads/' . $service->image) : asset('assets/assets/images/Mask.png') }}" class="d-block w-100" alt="Service Image">
