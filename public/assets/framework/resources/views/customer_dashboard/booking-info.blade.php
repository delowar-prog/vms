                ...
                <div class="col-6 my-auto d-flex justify-content-end" style="align-items: center;">
                    ...
                    @if($d && $d->return_flag == 1)
                        ...
                        @endphp
                            ...
                            @if(isset($p))
                                 <img src="{{url('/assets/assets/customer_dashboard/assets/assets/img/return_way.svg')}}" width="30" height="30" class="return-way">
                             @else
                            <img src="{{url('/assets/assets/customer_dashboard/assets/assets/img/one_way.svg')}}" width="30" height="30" class="one-way">
                    ...
                    <div class="dot-dropdown">
                        ...
                        <a class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/dropdown_dots.svg') }}" class="drop-img">
                        ...
                        <div class="col-6">
                            ...
                            <div class="vehicle_add_name_img">
                                ...
                                @if(isset($d->vehicle_id))
                                    ...
                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/vehicle.svg') }}" style="border-radius: 5px;">
