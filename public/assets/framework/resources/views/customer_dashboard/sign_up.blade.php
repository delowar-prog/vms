...
@endsection
@section('css')
<link rel="stylesheet" href="{{ asset('assets/assets/customer_dashboard/assets/assets/main_css/sign_up.css') }}">
        ...
        <div class="col-12">
            ...
            <nav id="myNavbar" class="d-flex d-sm-flex d-md-flex d-lg-none d-xl-none login_info navbar navbar-expand-lg  top-0 z-index-3 position-absolute  py-2 start-0 end-0 my-0">
                <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 space" href="{{url('/')}}">
                    <img src="{{ asset('assets/assets/images/'. Hyvikk::get('logo_img') ) }}">
                </a>
                                ...
                                <div class="features mb-4 mx-0">
                                    <div class="container px-0">
                                        <div class="row">
                                            <div class="col-4 d-flex justify-content-center">
                                                <div class="features-img">
                                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/search.svg')}}">
                                                </div>
                                            </div>
                                            <div class="col-8 d-flex align-items-center">
                                                <div class="feature-content ">
                                ...
                                <div class="features mb-4">
                                    <div class="container px-0">
                                        <div class="row">
                                            <div class="col-4 d-flex justify-content-center">
                                                <div class="features-img">
                                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/upgrade.svg')}}">
                                                </div>
                                            </div>
                                            <div class="col-8 d-flex align-items-center">
                                                <div class="feature-content ">
                                ...
                                <div class="features mb-4">
                                    <div class="container px-0">
                                        <div class="row">
                                            <div class="col-4 d-flex justify-content-center">
                                                <div class="features-img">
                                                    <img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/menu.svg')}}">
                                                </div>
                                            </div>
                                            <div class="col-8 d-flex align-items-center">
                                                <div class="feature-content ">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 mt-1 mb-1 mb-sm-0 mt-sm-0 mt-md-0 mb-md-0 mt-lg-0 mb-lg-0 mt-xl-0 mb-xl-0">
                                                        <label for="exampleInputEmail1" class="form-label mb-0">@lang('frontend.Password')
                                                            <div class="tooltip-container">
                                                                <span class="tooltip-trigger "><img src="{{ asset('assets/assets/customer_dashboard/assets/assets/img/svg/info-hexagon.svg') }}" class="ms-1"></span>
