                ...
                <div class="col-md-5">
                    ...
                    border-radius: 12px;">
                        ...
                        <tr>
                            ...
                            <td><a href="{{asset('/assets/assets/document_driver/'.$driver->getMeta('identify_front_face'))}}" target="_blank">Click Here</a></td>
                        ...
                        <tr>
                            ...
                            <td><a href="{{asset('/assets/assets/document_driver/'.$driver->getMeta('driving_license_back_side'))}}" target="_blank">Click Here</a></td>
                        ...
                        <tr>
                            ...
                            <td><a href="{{asset('/assets/assets/document_driver/'.$driver->getMeta('identify_backside'))}}" target="_blank">Click Here</a></td>
                        ...
                        <tr>
                            ...
                            <td><a href="{{asset('/assets/assets/document_driver/'.$driver->getMeta('criminal_record'))}}" target="_blank">Click Here</a></td>
                        ...
                        <tr>
                            ...
                            <td><a href="{{asset('/assets/assets/document_driver/'.$driver->getMeta('drivers_card'))}}" target="_blank">Click Here</a></td>
                        ...
                        <tr>
                            ...
                            <td><a href="{{asset('/assets/assets/document_driver/'.$driver->getMeta('drivers_license_gbt'))}}" target="_blank">Click Here</a></td>
                        ...
                        <tr>
                            ...
                            <td><a href="{{asset('/assets/assets/document_driver/'.$driver->getMeta('src_certificate'))}}" target="_blank">Click Here</a></td>
                        ...
                        <tr>
                            ...
                            <td><a href="{{asset('/assets/assets/document_driver/'.$driver->getMeta('psychotechnics'))}}" target="_blank">Click Here</a></td>
                        ...
                        <tr>
                            ...
                            <td><a href="{{asset('/assets/assets/document_driver/'.$driver->getMeta('tax_registration'))}}" target="_blank">Click Here</a></td>
                ...
                <div class="col-md-6">
                    ...
                    border-radius: 12px;">
                      ...
                      <tr>
                          ...
                          <td><a href="{{asset('/assets/assets/document_driver/'.$vehicle->getMeta('d2_vehicle_card'))}}" target="_blank">Click Here</a></td>
                      ...
                      <tr>
                          ...
                          <td><a href="{{asset('/assets/assets/document_driver/'.$vehicle->getMeta('ibb_road_route_certificate'))}}" target="_blank">Click Here</a></td>
                      ...
                      <tr>
                          ...
                          <td><a href="{{asset('/assets/assets/document_driver/'.$vehicle->getMeta('compulsory_seat_personal_accident_insurance'))}}" target="_blank">Click Here</a></td>
                      ...
                      <tr>
                          ...
                          <td><a href="{{asset('/assets/assets/document_driver/'.$vehicle->getMeta('sample_d2_carriage_contract'))}}" target="_blank">Click Here</a></td>
                      ...
                      <tr>
                          ...
                          <td><a href="{{asset('/assets/assets/document_driver/'.$vehicle->getMeta('sample_passanger_list'))}}" target="_blank">Click Here</a></td>
