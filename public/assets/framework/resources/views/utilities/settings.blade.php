...
<script type="text/javascript">
  ...
  $('.view4').click(function(){
    ...
    $('#myModal40 .modal-body .myimg').attr( "src","{{ asset('assets/assets/images/'. Hyvikk::get('fotter_logo_img') ) }}");
  ...
  $('.view1').click(function(){
    ...
    $('#myModal3 .modal-body .myimg').attr( "src","{{ asset('assets/assets/images/'. Hyvikk::get('icon_img') ) }}");
  ...
  $('.view2').click(function(){
    ...
    $('#myModal3 .modal-body .myimg').attr( "src","{{ asset('assets/assets/images/'. Hyvikk::get('logo_img') ) }}");
