...
class SettingsApiController extends Controller {
	...
	private function upload_file($file, $field, $name) {
		$destinationPath = './assets/assets/images'; // upload path
	...
	public function get_general_settings() {
		...
		$details = array(
			...
			'icon_image' => asset('assets/assets/images/' . Hyvikk::get('icon_img')),
			'logo_image' => asset('assets/assets/images/' . Hyvikk::get('logo_img')),
