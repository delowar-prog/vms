...
class UpdateVersion extends Controller {
	...
	public function move_folders() {
		// move all images of img,files folder to assets/assets/images folder and delete img,files folder
		$files = Storage::disk('public_files')->files();
		$imgs = Storage::disk('public_img')->files();
		foreach ($files as $file) {
			if (file_exists("files/" . $file)) {
				\File::copy("files/" . $file, "assets/assets/images/" . $file);
			}
		}
		foreach ($imgs as $img) {
			if (file_exists("img/" . $img)) {
				\File::copy("img/" . $img, "assets/assets/images/" . $img);
			}
		}
		// if (file_exists('img')) {
	...
	public function move_logo() {
		...
		$newPath = 'assets/assets/images/' . Hyvikk::get('icon_img');
		if (file_exists("public/" . Hyvikk::get('icon_img'))) {
			\File::copy($oldPath, $newPath);
		}
		$oldPath1 = "public/" . Hyvikk::get('logo_img');
		$newPath1 = 'assets/assets/images/' . Hyvikk::get('logo_img');
