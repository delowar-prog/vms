			...
			return DataTables::eloquent($bookings)
				...
				->addColumn('return_booking', function ($row) {
					...
					if($row->getMeta('return') == 1)
					{
						...
						if(isset($b))
						{
							return url('/assets/assets/customer_dashboard/assets/assets/img/return_way5.svg');
						}
						else
						{
							return url('/assets/assets/customer_dashboard/assets/assets/img/one_way5.svg');
						}
					}
					else
					{
